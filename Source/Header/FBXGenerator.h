...
public:
	...
	void BuildFBXTexture(std::vector<Material>& outMaterial, std::string inTextureName, std::string inMaterialName, Textures & mTextures, Materials & mMaterials);

	void LoadFBXPlayer(Player& mPlayer, Textures & mTextures, Materials & mMaterials);
